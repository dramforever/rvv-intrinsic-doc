...
vint32mf2_t __riscv_vqdot(vint32mf2_t vd, vint8mf2_t vs2, vint8mf2_t vs1,
                          size_t vl);
vint32mf2_t __riscv_vqdot(vint32mf2_t vd, vint8mf2_t vs2, int32_t rs1,
                          size_t vl);
vint32m1_t __riscv_vqdot(vint32m1_t vd, vint8m1_t vs2, vint8m1_t vs1,
                         size_t vl);
vint32m1_t __riscv_vqdot(vint32m1_t vd, vint8m1_t vs2, int32_t rs1, size_t vl);
vint32m2_t __riscv_vqdot(vint32m2_t vd, vint8m2_t vs2, vint8m2_t vs1,
                         size_t vl);
vint32m2_t __riscv_vqdot(vint32m2_t vd, vint8m2_t vs2, int32_t rs1, size_t vl);
vint32m4_t __riscv_vqdot(vint32m4_t vd, vint8m4_t vs2, vint8m4_t vs1,
                         size_t vl);
vint32m4_t __riscv_vqdot(vint32m4_t vd, vint8m4_t vs2, int32_t rs1, size_t vl);
vint32m8_t __riscv_vqdot(vint32m8_t vd, vint8m8_t vs2, vint8m8_t vs1,
                         size_t vl);
vint32m8_t __riscv_vqdot(vint32m8_t vd, vint8m8_t vs2, int32_t rs1, size_t vl);
...
vint32m8_t __riscv_vqdotsu(vint32m8_t vd, vint8m8_t vs2, uint32_t rs1,
                           size_t vl);
vint32mf2_t __riscv_vqdotus(vint32mf2_t vd, vuint8mf2_t vs2, int32_t rs1,
                            size_t vl);
vint32m1_t __riscv_vqdotus(vint32m1_t vd, vuint8m1_t vs2, int32_t rs1,
                           size_t vl);
vint32m2_t __riscv_vqdotus(vint32m2_t vd, vuint8m2_t vs2, int32_t rs1,
                           size_t vl);
vint32m4_t __riscv_vqdotus(vint32m4_t vd, vuint8m4_t vs2, int32_t rs1,
                           size_t vl);
vint32m8_t __riscv_vqdotus(vint32m8_t vd, vuint8m8_t vs2, int32_t rs1,
                           size_t vl);
...
vint32m4_t __riscv_vqdot(vbool8_t vm, vint32m4_t vd, vint8m4_t vs2, int32_t rs1,
                         size_t vl);
vint32m8_t __riscv_vqdot(vbool4_t vm, vint32m8_t vd, vint8m8_t vs2,
                         vint8m8_t vs1, size_t vl);
vint32m8_t __riscv_vqdot(vbool4_t vm, vint32m8_t vd, vint8m8_t vs2, int32_t rs1,
                         size_t vl);
