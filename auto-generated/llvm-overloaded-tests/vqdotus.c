...
vint32mf2_t test_vqdotus_vx_i32mf2(vint32mf2_t vd, vuint8mf2_t vs2, int32_t rs1,
                                   size_t vl) {
  return __riscv_vqdotus(vd, vs2, rs1, vl);
}

vint32m1_t test_vqdotus_vx_i32m1(vint32m1_t vd, vuint8m1_t vs2, int32_t rs1,
                                 size_t vl) {
  return __riscv_vqdotus(vd, vs2, rs1, vl);
}

vint32m2_t test_vqdotus_vx_i32m2(vint32m2_t vd, vuint8m2_t vs2, int32_t rs1,
                                 size_t vl) {
  return __riscv_vqdotus(vd, vs2, rs1, vl);
}

vint32m4_t test_vqdotus_vx_i32m4(vint32m4_t vd, vuint8m4_t vs2, int32_t rs1,
                                 size_t vl) {
  return __riscv_vqdotus(vd, vs2, rs1, vl);
}

vint32m8_t test_vqdotus_vx_i32m8(vint32m8_t vd, vuint8m8_t vs2, int32_t rs1,
                                 size_t vl) {
  return __riscv_vqdotus(vd, vs2, rs1, vl);
}
