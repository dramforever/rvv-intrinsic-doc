...
vint32mf2_t test_vqdot_vx_i32mf2_tu(vint32mf2_t vd, vint8mf2_t vs2, int32_t rs1,
                                    size_t vl) {
...
vint32m1_t test_vqdot_vx_i32m1_tu(vint32m1_t vd, vint8m1_t vs2, int32_t rs1,
                                  size_t vl) {
  return __riscv_vqdot_tu(vd, vs2, rs1, vl);
}
...
vint32m2_t test_vqdot_vx_i32m2_tu(vint32m2_t vd, vint8m2_t vs2, int32_t rs1,
                                  size_t vl) {
  return __riscv_vqdot_tu(vd, vs2, rs1, vl);
}
...
vint32m4_t test_vqdot_vx_i32m4_tu(vint32m4_t vd, vint8m4_t vs2, int32_t rs1,
                                  size_t vl) {
  return __riscv_vqdot_tu(vd, vs2, rs1, vl);
}
...
vint32m8_t test_vqdot_vx_i32m8_tu(vint32m8_t vd, vint8m8_t vs2, int32_t rs1,
                                  size_t vl) {
  return __riscv_vqdot_tu(vd, vs2, rs1, vl);
}
...
vint32mf2_t test_vqdot_vx_i32mf2_tum(vbool64_t vm, vint32mf2_t vd,
                                     vint8mf2_t vs2, int32_t rs1, size_t vl) {
