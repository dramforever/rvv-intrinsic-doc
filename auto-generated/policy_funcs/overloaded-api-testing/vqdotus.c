...
vint32m1_t test_vqdotus_vx_i32m1_tu(vint32m1_t vd, vuint8m1_t vs2, int32_t rs1,
                                    size_t vl) {
  return __riscv_vqdotus_tu(vd, vs2, rs1, vl);
}

vint32m2_t test_vqdotus_vx_i32m2_tu(vint32m2_t vd, vuint8m2_t vs2, int32_t rs1,
                                    size_t vl) {
  return __riscv_vqdotus_tu(vd, vs2, rs1, vl);
}

vint32m4_t test_vqdotus_vx_i32m4_tu(vint32m4_t vd, vuint8m4_t vs2, int32_t rs1,
                                    size_t vl) {
  return __riscv_vqdotus_tu(vd, vs2, rs1, vl);
}

vint32m8_t test_vqdotus_vx_i32m8_tu(vint32m8_t vd, vuint8m8_t vs2, int32_t rs1,
                                    size_t vl) {
  return __riscv_vqdotus_tu(vd, vs2, rs1, vl);
}
...
vint32m1_t test_vqdotus_vx_i32m1_tum(vbool32_t vm, vint32m1_t vd,
                                     vuint8m1_t vs2, int32_t rs1, size_t vl) {
  return __riscv_vqdotus_tum(vm, vd, vs2, rs1, vl);
}

vint32m2_t test_vqdotus_vx_i32m2_tum(vbool16_t vm, vint32m2_t vd,
                                     vuint8m2_t vs2, int32_t rs1, size_t vl) {
  return __riscv_vqdotus_tum(vm, vd, vs2, rs1, vl);
}
